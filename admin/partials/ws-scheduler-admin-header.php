...
<div class="ws-adminbar">
  ...
  <div class="ws-adminbar-links">
    ...
    <a class="ws-alink <?php echo ( isset( $_GET['page'] ) && $_GET['page'] === 'ws-scheduler-licence' ) ? 'active' : ''; ?>"
       href="<?php echo esc_url( admin_url( 'admin.php?page=ws-scheduler-licence' ) ); ?>"><?php esc_html_e( 'Licence Pro', 'ws-scheduler' ); ?></a>
  </div>
